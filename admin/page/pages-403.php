...
<head>
	...
	<!-- Core CSS -->
	<link rel="stylesheet" href="../resource/assets/vendor/css/core.css" class="template-customizer-core-css"/>
	<link rel="stylesheet" href="../resource/assets/vendor/css/theme-default.css"
...
<div class="container-xxl container-p-y">
	<div class="misc-wrapper">
		...
		<p class="mb-4 mx-2">Sorry, bạn cần có quyền truy cập. Hãy yêu cầu quyền truy cập hoặc chuyển sang tài khoản có
			quyền!!!</p>
		<a href="index.php" class="btn btn-primary">Về lại trang chủ</a>
		<div class="mt-4">
			<img
					src="../resource/assets/img/illustrations/403%20Error%20Forbidden-rafiki.png"
