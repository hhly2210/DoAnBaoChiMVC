        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit-form" action="edit.php" method="POST" enctype="multipart/form-data">
                    ...
                    <img id="edit-preview-avatar" class="d-block mx-auto my-1 rounded-circle" style="width: 7.5em; height: 7.5em;">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            <input type="email" id="edit-Email" class="form-control" name="Email" aria-describedby="Email2" placeholder=""><span class="input-group-text" id="edit-Email2">@gmail.com</span>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="edit-adminPass" value='' placeholder="**********" name="adminPass" style="-webkit-text-security: disc;">
                    </div>
                    <div class="mb-3">
